...
export default function UniversityForm() {
 ...
 const onSubmit = async (data: FormValues) => {
  ...
  try {
    ...
    const errorMessage = error.response?.data?.message || 'Failed to create university. Please try again.';
    toast.error(errorMessage);
    
    // If validation errors, log them for debugging
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-8">Add New University</h1>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex justify-end">
            <Button type="submit" disabled={isLoading}>
              {isLoading ? 'Submitting...' : 'Submit University'}
            </Button>
          </div>
        </form>
      </Form>

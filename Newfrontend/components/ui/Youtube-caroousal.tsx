        ...
        <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
            <section className="py-20">
                <div className="text-center space-y-2 mb-10">
                    <h2 className="text-lg text-primary uppercase tracking-wider">Student Life Abroad</h2>
                ...
                <div className="relative w-full">
                    <div
                        ...
                        className="flex w-full overflow-x-scroll scroll-smooth gap-4 pl-4 max-w-7xl mx-auto py-6"
                    >

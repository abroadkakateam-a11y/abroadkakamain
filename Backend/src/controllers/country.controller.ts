...
export const updateCountry = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const updatedCountry = await countryService.updateCountry(req.params.id, updateData);
        res.status(200).json({
            status: 'success',
...
export const uploadCountryFlag = (req: Request, res: Response, next: NextFunction) => {
